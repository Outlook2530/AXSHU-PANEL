...
def index():
    ...
    <body>
      <div class="container text-center">
        ...
        <!-- Navigation Buttons -->
        <a href="/user/panel" class="btn btn-info w-100 btn-custom">Go to User Panel</a>
        <a href="/admin/login" class="btn btn-warning w-100 btn-custom">Go to Admin Panel</a>
      </div>
    </body>
    </html>
    """)
    ...
    <body class="bg-dark text-white">
      <div class="container py-5">
        ...
        <div class="text-center mt-4">
          ...
          <a href="/admin/login" class="btn btn-warning">Go to Admin Panel</a>
        </div>
      </div>
...
def admin_login():
    ...
    <body>
      ...
      <div class="mt-3">
        <a href="/" style="color:cyan;">🏠 Home</a>
        <a href="/user/panel" style="color:yellow;">User Panel</a>
      </div>
    </body>
    </html>
    '''
...
<body class="bg-dark text-white">
  <div class="container py-5">
    ...
    <p class="text-center">Yahan tumhe sab users aur unke threads ki monitoring milegi.</p>

    <div class="text-center mt-4">
      <a href="/" class="btn btn-light">🏠 Home</a>
      <a href="/user/panel" class="btn btn-info">User Panel</a>
    </div>
  </div>
</body>
</html>
